...
#
def TestFunc():
    pd_id = "103309"  # 用户信息页可以查询到pd信息
    pd_key = "CJ5ynY2Cimae821VBy5d5UHUJ2UObdCQ"
    app_id = "303509"  # 开发者分成用的账号，在开发者中心可以查询到
    app_key = "TAHfXXdlYO7ui0du61aDnT/0LzoZZrnj"
    # 识别类型，
    # 具体类型可以查看官方网站的价格页选择具体的类型，不清楚类型的，可以咨询客服

    # TODO 4位纯数字 10400 4位纯英文20400 4位混合中英文30400
    # TODO 正确设置虽然不能省钱，但是可以提高成功率
    pred_type = "30400"

    api = FateadmApi(app_id, app_key, pd_id, pd_key)
    api.QueryBalc()
    # 如果不是通过文件识别，则调用Predict接口
    file_name = "english.jpg"
